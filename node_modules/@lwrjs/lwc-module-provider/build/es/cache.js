...
let moduleCount = 0;
export async function addCompiledModuleCacheEntry(moduleSource, compilerResult, targetSSR, { lwcCacheIndex, lwcCacheDir }) {
...
export function getCompiledModuleCacheEntry({ specifier, version, ownHash }, targetSSR, { lwcCacheIndex, lwcCacheDir }) {
    const cacheKey = getCacheKey(specifier, version, targetSSR);
