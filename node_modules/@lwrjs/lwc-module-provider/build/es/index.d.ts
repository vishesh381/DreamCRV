import type { AbstractModuleId, ModuleCompiled, ModuleEntry, ModuleProvider, ModuleSource, ProviderContext, RuntimeParams } from '@lwrjs/types';
...
export default class LwcModuleProvider implements ModuleProvider {
     ...
     */
    createGetModuleJob(moduleId: AbstractModuleId, runtimeParams: RuntimeParams): Promise<ModuleCompiled | undefined>;
    getModuleSource({ name, namespace, specifier }: AbstractModuleId, moduleEntry: ModuleEntry): Promise<ModuleSource>;
    getModuleEntry({ specifier, importer, version }: AbstractModuleId, runtimeParams?: RuntimeParams): Promise<ModuleEntry | undefined>;
    createModuleEntry({ specifier, importer, version }: AbstractModuleId, runtimeParams: RuntimeParams): Promise<ModuleEntry | undefined>;
