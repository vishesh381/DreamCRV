...
export declare function addCompiledModuleCacheEntry(moduleSource: ModuleSource, compilerResult: CompilerResult, targetSSR: boolean, { lwcCacheIndex, lwcCacheDir }: ModuleCacheContext): Promise<any>;
export declare function getCompiledModuleCacheEntry({ specifier, version, ownHash }: ModuleSource, targetSSR: boolean, { lwcCacheIndex, lwcCacheDir }: ModuleCacheContext): CompilerResult | undefined;
