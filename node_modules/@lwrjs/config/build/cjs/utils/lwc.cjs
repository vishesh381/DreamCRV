...
// packages/@lwrjs/config/src/utils/lwc.ts
__markAsModule(exports);
__export(exports, {
  normalizeLwcConfig: () => normalizeLwcConfig,
  normalizeModulePaths: () => normalizeModulePaths
});
...
function normalizeModulePaths(modules, rootDir) {
