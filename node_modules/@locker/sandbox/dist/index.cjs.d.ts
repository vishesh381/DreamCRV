...
type DistortionToToggleSwitch = {
    [key: string]: boolean;
};
type DistortionsToggleSwitches = {
    distortions: DistortionToToggleSwitch;
};
type NamespaceToDistortionsToggleSwitches = {
    [key: string]: DistortionsToggleSwitches;
};
type $LightningWebSecurity = {
    namespaces: NamespaceToDistortionsToggleSwitches;
};
declare global {
    interface Window {
        $LWS: $LightningWebSecurity;
    }
}
...
declare const $LWS: import("../dist/index.mjs").$LightningWebSecurity;
...
declare function createRootWindowSandboxRecord({ 
