...
export declare const enum Context {
    ...
    SuperCall = 524288,
    InYieldContext = 1048576,
    InAwaitContext = 2097152,
    InArgumentList = 4194304,
    InConstructor = 8388608,
    InMethod = 16777216,
    AllowNewTarget = 33554432,
    DisallowIn = 67108864,
    AllowEscapedKeyword = 134217728,
    OptionsUniqueKeyInPattern = 268435456
}
