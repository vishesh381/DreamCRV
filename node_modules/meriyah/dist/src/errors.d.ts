...
export declare const enum Errors {
    ...
    InvalidJSONImportBinding = 137,
    ImportNotOneArg = 138,
    InvalidImportNew = 139,
    InvalidSpreadInImport = 140,
    UncompleteArrow = 141,
    DuplicateBinding = 142,
    DuplicateExportBinding = 143,
    UndeclaredExportedBinding = 144,
    UnexpectedPrivateField = 145,
    DuplicateLetConstBinding = 146,
    CantAssignToValidRHS = 147,
    ContinuousNumericSeparator = 148,
    TrailingNumericSeparator = 149,
    InvalidJSXAttributeValue = 150,
    ExpectedJSXClosingTag = 151,
    AdjacentJSXElements = 152,
    InvalidNonEmptyJSXExpr = 153,
    DuplicateIdentifier = 154,
    ShadowedCatchClause = 155,
    InvalidDotProperty = 156,
    UnclosedSpreadElement = 157,
    CatchWithoutTry = 158,
    FinallyWithoutTry = 159,
    UnCorrespondingFragmentTag = 160,
    InvalidCoalescing = 161,
    OptionalChainingNoTemplate = 162,
    OptionalChainingNoSuper = 163,
    OptionalChainingNoNew = 164,
    ImportMetaOutsideModule = 165,
    InvalidLeadingDecorator = 166
}
