...
export declare function parseImportAttributes(parser: ParserState, context: Context, specifiers?: ESTree.ImportDeclaration['specifiers']): ESTree.ImportAttribute[];
